...
<%@ Register TagPrefix="dnn" TagName="ManageAccount" Src="~/DesktopModules/ManageAccount/Controls/AddEmailAddressRecoveryQuestions.ascx" %>
<%@ Register TagPrefix="dnn" TagName="UserAccountSettings" Src="~/DesktopModules/YA.Controls/ManageAccount/UserAccountSettings/UserAccountSettings.ascx" %>
...
<div class="dnnForm dnnEditUser dnnClear" id="dnnEditUser" runat="server" ClientIDMode="Static">
  <%--  <ul class="dnnAdminTabNav dnnClear" id="adminTabNav" runat="server">
    ...
    <div id="dnnUserDetails" class="dnnUserDetails dnnClear">
        <div class="udContent dnnClear">
            ...
            <div id="divSuccessfullyAddedNotifications" class="alert alert-success" style="display: none;">
                <span data-icon="&#x34" aria-hidden="true"></span>
                <strong>Information Successfully Saved</strong>
            </div>

            <h1 class="dnnFormSectionHead">
                    Manage Account</h1>

			<dnn:UserAccountSettings id="UserAccountSettings" runat="server"></dnn:UserAccountSettings >
 ...
 <%--   <div id="dnnServicesDetails" runat="server" visible="false" class="dnnServicesDetails dnnClear">
    ...
    <div class="dnnClear">
    	<dnn:ManageAccount id="ctlRecoveryQuestions" runat="server"></dnn:ManageAccount>
    </div>
